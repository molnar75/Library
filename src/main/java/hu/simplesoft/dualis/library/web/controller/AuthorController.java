...
public class AuthorController {
    ...
    public void deleteAddress(@Valid @PathVariable("id") IdRequest idRequest) throws ServiceException {
        this.authorService.deleteAuthor(idRequest.getId());
    }
    
    @GetMapping("/getAuthorById/{id}")
    public AuthorDto getAuthorById(@Valid @PathVariable("id") IdRequest idRequest) throws ServiceException {
        return this.authorService.getAuthorById(idRequest.getId());
    }
