...
public class BorrowedBookDaoImpl implements BorrowedBookDao {
    ...
    @Transactional
    @Override
    public void createBorrowedBook(BorrowedBookDto borrowedBookDto) throws PersistException {
    ...
    @Transactional
    @Override
    public void updateBorrowedBook(BorrowedBookDto borrowedBookDto) throws PersistException {
    ...
    @Transactional
    @Override
    public void deleteBorrowedBook(long borrowedBookId) throws PersistException {
    ...
    @Override
    public List<BorrowedBookDto> getAllBorrowedBooks() throws PersistException {
    ...
    @Override
    public BorrowedBookDto getBorrowedBookById(long borrowedBookId) throws PersistException {
